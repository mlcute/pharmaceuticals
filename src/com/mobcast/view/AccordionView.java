...
public class AccordionView extends LinearLayout {
	...
	public void setSectionHeaders(String mStr){
		mHeaderTextView.setText(mStr);
//		invalidate();
	}
...
//				.getAssets());
	...
	private View getViewHeader(LayoutInflater inflater, final int position,
		...
		mHeaderTextView = ((TextView) view.findViewById(headerLabel));
				mHeaderTextView.setText(sectionHeaders[position]);

...
public class Switch extends CustomView {
	...
	protected void setAttributes(AttributeSet attrs) {
		...
		//æ·»åŠ ç›‘å�¬å™¨ï¼Œå¦‚æžœç‚¹å‡»äº†è¿™ä¸ªæŽ§ä»¶ï¼ˆä¸�åŒ…æ‹¬ballçš„åŒºåŸŸï¼‰ï¼Œè¿™ä¸ªæŽ§ä»¶å°±å¼€å§‹åˆ¤æ–­æ˜¯å�¦æ˜¯å¼€å�¯çŠ¶æ€�ã€‚
		...
		setThumbParams(size);
		addView(ball);
		// ç»™åœ†ç�ƒæ·»åŠ ç›‘å�¬å™¨ï¼Œç‚¹å‡»åœ†ç�ƒå�Žå°±å¼€å§‹åˆ¤æ–­æ˜¯å�¦è¿›å…¥å¼€å�¯çŠ¶æ€�
	...
	private void setThumbParams(float size) {
		RelativeLayout.LayoutParams params = new LayoutParams(
				Utilities.dpToPx(size, getResources()), Utilities.dpToPx(size, getResources()));
